...
const AccessApprovedModal = ({
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/20 flex items-center justify-center px-4 z-50">
      {/* Modal card */}
      <div className="bg-white w-full max-w-sm max-h-[85vh] overflow-y-auto rounded-xl border border-gray-200 shadow-xl px-6 py-6 flex flex-col items-center gap-4">
        {/* Success icon */}
        <div className="h-14 w-14 rounded-full border-2 border-green-400 flex items-center justify-center">
          <CheckIcon className="h-7 w-7 text-green-500 stroke-[2.5]" />
        </div>

        {/* Title + message */}
        <div className="text-center space-y-2">
          <h1 className="text-lg font-bold">Access Approved</h1>
        ...
        {temporaryPassword && (
          <div className="w-full bg-blue-50 border border-blue-100 rounded-lg px-4 py-2.5 text-center">
