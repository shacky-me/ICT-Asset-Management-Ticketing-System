...
export const createAsset = async (data, userId) => {
    const { tagNo, systemAssetId, category, subCategory, assetDescription, make, model, physicalCondition, serialNumber, macAddress, imeiNumber, color, departmentId, } = data;
    // ✅ Validation
    if (!tagNo ||
        !serialNumber ||
        !category ||
